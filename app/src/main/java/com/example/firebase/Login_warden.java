        ...
        log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(Email) || TextUtils.isEmpty(Password)) {
                    Toast.makeText(Login_warden.this, "Enter Email and Password ", Toast.LENGTH_LONG).show();
                    return;
                }

                if(validateEmail(Email)) {
                    rootDB.child("Login_Warden").addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (isLoginValid) {
                                ...
                                Toast.makeText(Login_warden.this, "Authentication Completed.",
                                ...
                                Toast.makeText(Login_warden.this, "Invalid email or password", Toast.LENGTH_SHORT).show();
                            }
                        ...
                        public void onCancelled(DatabaseError error) {
                            ...
                            Toast.makeText(Login_warden.this, "Database error occurred", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else{
                    Toast.makeText(Login_warden.this, "Invalid Email Format", Toast.LENGTH_LONG).show();
                }
            }
        });
