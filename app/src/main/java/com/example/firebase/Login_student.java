        ...
        log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(Email) || TextUtils.isEmpty(Password)) {
                    Toast.makeText(Login_student.this, "Enter Email and Password ", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                rootDB.child("Login").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (isLoginValid) {
                            ...
                            Toast.makeText(Login_student.this, "Authentication Completed.",
                            ...
                            Toast.makeText(Login_student.this, "Invalid email or password", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onCancelled(DatabaseError error) {
                        ...
                        Toast.makeText(Login_student.this, "Database error occurred", Toast.LENGTH_SHORT).show();
                    }
                });
            }
                else{
                    Toast.makeText(Login_student.this, "Invalid Email Format", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
